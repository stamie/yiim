...
class NausysPort  extends PortSync {
    ...
    public function __construct($ID = null, $wpId = 0, $wpPrefix, $xmlJsonId, $name_, $isActive = 1, $country_id, $lon = null, $lat=null, $wp_lon = null, $wp_lat = null)
    {
        $xmlId = 0;
        ...
        parent::__construct($ID, $wpId, $wpPrefix, $xmlId, $xmlJsonId, $name_, $isActive, $country_id, $lon, $lat, $wp_lon, $wp_lat);
