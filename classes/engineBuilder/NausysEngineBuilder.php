...
use app\classes\engineBuilder\EngineBuilderSync;
use app\classes\Nausys;
use app\models\EngineBuilder;
use app\models\Xml;

class NausysEngineBuilder  extends EngineBuilderSync {

    private static $resturl = 'http://ws.nausys.com/CBMS-external/rest/catalogue/v6/engineBuilders';
    private static $modelName = 'app\classes\engineBuilder\NausysEngineBuilder';
