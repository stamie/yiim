...
class NausysRegion  extends RegionSync {
    ...
    public function __construct($ID = null, $wpId = 0, $wpPrefix, $xmlJsonId, $name_, $isActive = 1, $country_id)
    {
        $xmlId = 0;
        ...
        parent::__construct($ID, $wpId, $wpPrefix, $xmlId, $xmlJsonId, $name_, $isActive, $country_id);
